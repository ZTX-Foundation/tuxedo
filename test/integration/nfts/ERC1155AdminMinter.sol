...
contract IntegrationTestERC1155AdminMinter is BaseTest {
    ...
    function testSetSupplyCap() public {
        /// set supply cap
        vm.prank(multisig);
        erc1155Wearables.setSupplyCap(1108, 10_000);
        assertEq(erc1155Wearables.maxTokenSupply(1108), 10_000);
    }
    ...
    function testMintSuccess() public {
        ...
        /// mint
        vm.prank(multisig);
        erc1155AdminMinter.mintToken(address(erc1155Wearables), recipient, 1108, 10_000);
        assertEq(erc1155Wearables.balanceOf(recipient, 1108), 10_000);
    }

    function testbulkMintTokensSuccess() public {
        /// set supply cap
        vm.startPrank(multisig);
        erc1155Wearables.setSupplyCap(1106, 10_000);
        erc1155Wearables.setSupplyCap(1108, 10_000);
        assertEq(erc1155Wearables.maxTokenSupply(1106), 10_000);
        assertEq(erc1155Wearables.maxTokenSupply(1108), 10_000);
        vm.stopPrank();

        ERC1155AdminMinter.BulkMint[] memory toMint = new ERC1155AdminMinter.BulkMint[](2);
        toMint[0] = ERC1155AdminMinter.BulkMint(address(erc1155Wearables), 1106, 10_000, recipient);
        toMint[1] = ERC1155AdminMinter.BulkMint(address(erc1155Wearables), 1108, 10_000, recipient);
        ...
        // assert
        assertEq(erc1155Wearables.balanceOf(recipient, 1106), 10_000);
        assertEq(erc1155Wearables.balanceOf(recipient, 1108), 10_000);
    }
    ...
    function testMintFailOverSupplyLimit() public {
        ...
        vm.prank(multisig);
        vm.expectRevert("BaseERC1155NFT: supply exceeded");
        erc1155AdminMinter.mintToken(address(erc1155Wearables), recipient, 1108, 100_000);
    }
    ...
    function testBulkMintTokenFailOverSupplyLimit() public {
        ...
        ERC1155AdminMinter.BulkMint[] memory toMint = new ERC1155AdminMinter.BulkMint[](2);
        toMint[0] = ERC1155AdminMinter.BulkMint(address(erc1155Wearables), 1106, 20_000, recipient);
        toMint[1] = ERC1155AdminMinter.BulkMint(address(erc1155Wearables), 1108, 20_000, recipient);
