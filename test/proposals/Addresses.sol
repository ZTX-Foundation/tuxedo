...
contract Addresses is Test {
    ...
    constructor() {
        ...
        */
        ...
        /// Contracts
        _addAddress("CORE", 421613, 0xDe4d49cC1F2290F2E9c1819bB08fd9eE27e85e10);
        _addAddress("GLOBAL_REENTRANCY_LOCK", 421613, 0xbDa804c509876208B1427dDB9c3fA198bD592Dcc);
        _addAddress("ERC1155_MAX_SUPPLY_MINTABLE_CONSUMABLES", 421613, 0xcEe5a709Cc84602682ba1daa0D32160B877b7d23);
        _addAddress("ERC1155_MAX_SUPPLY_MINTABLE_PLACEABLES", 421613, 0x7F4947658C92bD6354aE86bb338B7D5EB4EcD4A5);
        _addAddress("ERC1155_MAX_SUPPLY_MINTABLE_WEARABLES", 421613, 0x4fC879B3F1bb8042ba1355b626c09aCA860946a4);
        _addAddress("ERC1155_AUTO_GRAPH_MINTER", 421613, 0x048e3E22DbdA4a654D80A1Ad2c35d45CFB0DBE40);
        _addAddress("WETH_ERC20_HOLDING_DEPOSIT", 421613, 0xa4BDe75354C3676501089F276742B0E0A4A33b01);
        _addAddress("ERC1155_SALE_CONSUMABLES", 421613, 0x9481fB6dE0191d64056E6381fda01f5AD89C6438);
        _addAddress("ERC1155_SALE_PLACEABLES", 421613, 0x4576e12B73e8E6639379f03dfbD758D86D659557);
        _addAddress("ERC1155_SALE_WEARABLES", 421613, 0x2eDA363797939661Dbc9c60e7e952869F2b73A1B);
        _addAddress("FINANCE_GUARDIAN", 421613, 0x51939A75530ff4600795097574554BEa5be35BA9);
        _addAddress("TOKEN", 421613, 0x01a283489544EF558034bcFF99DBA8F79467b4A7);
        _addAddress("GOVERNOR_DAO", 421613, 0x0CF950b4e2C939916E595070eC460BeFFA9A572a);
        _addAddress("GOVERNOR_DAO_TIMELOCK_CONTROLLER", 421613, 0x0E01AAe38414611B446C0843b8bC491F67571615);
        _addAddress("ADMIN_TIMELOCK_CONTROLLER", 421613, 0x424d7CCceA75F1c42aF56fC223AD560e6eCaE6c3);
        _addAddress("BURNER_WALLET", 421613, 0x96554C1D09907aC27a336e2300D082527163C7a7);
        _addAddress("TREASURY_WALLET", 421613, 0xFea3F87bbAcCa68D074AaD05f3891267A1D21a33);
        _addAddress("WETH_TREASURY_WALLET", 421613, 0x71E1Fc5bb31e7a4891E1a611aD84E3BF145aa9A7);
        _addAddress("CONSUMABLE_SPLITTER", 421613, 0x346D3AAC8E2fA297ec26b37c3EFc331D08997990);
        _addAddress("ERC1155_SALE_SPLITTER", 421613, 0xdBF55CcC2D393444287dbfC60849da2E347A3cfD);
        _addAddress("GAME_CONSUMABLE", 421613, 0xD406Ba326A187A8756fB096793b71b69Be3D91d5);
