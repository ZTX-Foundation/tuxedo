    ...
    GovernorCountingSimple
{
    ...
    function setVotingDelay(uint256 newVotingDelay) public override onlyRole(Roles.GOVERNOR_DAO_PROTOCOL_ROLE) {
    ...
    function setVotingPeriod(uint256 newVotingPeriod) public override onlyRole(Roles.GOVERNOR_DAO_PROTOCOL_ROLE) {
        _setVotingPeriod(newVotingPeriod);
    }

    /// @notice Override of a GovernorSettings.sol function, to restrict to Core TOKEN_GOVERNOR role.
    function setProposalThreshold(uint256 newProposalThreshold) public override onlyRole(Roles.GOVERNOR_DAO_PROTOCOL_ROLE) {
        _setProposalThreshold(newProposalThreshold);
    }

    /// @notice Adjust quorum, restricted to TOKEN_GOVERNOR role.
    function setQuorum(uint256 newQuorum) public onlyRole(Roles.GOVERNOR_DAO_PROTOCOL_ROLE) {
