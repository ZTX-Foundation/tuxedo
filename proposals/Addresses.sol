...
contract Addresses is Test {
    ...
    constructor() {
        ...
        _addAddress("REVENUE_WALLET_MULTISIG01", 42161, 0x0000000000000000000000000000000000000002); // TODO Naming
        _addAddress("REVENUE_WALLET_MULTISIG02", 42161, 0x0000000000000000000000000000000000000003); // TODO Naming
        _addAddress("GUARDIAN_MULTISIG", 42161, 0x0000000000000000000000000000000000000004);
