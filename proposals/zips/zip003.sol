...
contract zip003 is Proposal, TimelockProposal {
    ...
    string public description = "Post CGV1 ZTX proposal";
    ...
    function _run(Addresses addresses, address deployer) internal override {
        this.setDebug(true); /// set debug to true to log out calldata for submitting to the multisig

        /// @notice this won't work until you actually have a timelock properly set up on mainnet,
        /// this is just an example, but it will work once a properly configured timelock is deployed
        _simulateTimelockActions(
            addresses.getAddress("TIMELOCK"),
